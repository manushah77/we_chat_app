...
class APIs {
  ...
  static Future<bool> addChatUser(String name) async {
    final data =
        await firestore.collection('user').where('name', isEqualTo: name).get();
  ...
  static Future<void> sendFirstMessage(
      ChatUser chatUser, String msg, Typee type) async {
    await firestore
        .collection('user')
        .doc(chatUser.id)
        .collection('my_users')
  ...
  static Future<void> sendMessage(
    ...
    await ref.doc(time).set(message.toJson()).then((value) =>
        sendPushNotification(chatUser, type == Typee.text ? msg : 'image'));
  }
  ...
  static Future<void> deleteMessage(Messges message) async {
    ...
    if (message.type == Typee.image) {
      await storage.refFromURL(message.msg!).delete();
    }
  }

  //update message
  static Future<void> updateMessage(Messges message, String updatedMsg) async {
    await firestore
        .collection('chats/${getConversationID(message.toId!)}/messages/')
        .doc(message.sent)
